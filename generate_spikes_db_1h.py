...
# e.g.: find 2010/07/12 -type f -name "*.fits" ! -name .DS_Store > file_list_2010.txt
source_file_list = 'file_list_2010_07_11_1hr.txt'
spikes = SpikesDB(source_file_list, datadir, 'spikes_df_2010_07_11_1hr.parquet')
